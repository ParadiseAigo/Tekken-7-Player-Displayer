...
#define OPPONENT_STRUCT_NAME_STATIC_POINTER 0x1434D24A0 // changed last update
#define OPPONENT_STRUCT_NAME_POINTER_OFFSETS {0, 0x8, 0x11C}

#define OPPONENT_STRUCT_CHARACTER_STATIC_POINTER 0x1434D24A0 // changed last update
